            ...
            <div class="card-body p-4">
                <div class="tab-content" id="manageClassTabContent">
                    ...
                    <div class="tab-pane fade show active" id="schedule" role="tabpanel"
                        aria-labelledby="schedule-tab-btn">
            ...
            <div class="modal-content">
                ...
                <form id="studentModalForm">
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="student_user_id" class="form-label">Cari Siswa (bisa pilih lebih dari
                                satu)</label>
                            <select class="form-select" id="student_user_id" name="user_ids[]" required
