                ...
                <div class="row align-items-center">
                    <div class="col-lg-7">
                        ...
                        <div class="d-flex flex-wrap gap-4 text-muted">
                            ...
                            <div class="text-primary fw-bold" id="grading-timer-container" style="display:none;">
                                <i class="fas fa-stopwatch me-2"></i><span id="grading-timer">00:00:00</span>
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        function renderForm(data) {
            ...
            // [BARU] Setup Timer
            // Controller sekarang menjamin grading_started_at selalu ada saat detail dibuka
            if (data.grading_started_at) {
                startGradingTimer(data.grading_started_at);
            } else {
                // Fallback visual jika entah kenapa null (seharusnya tidak kejadian)
                $('#grading-timer-container').show();
                $('#grading-timer').text("00:00:00");
                // Mulai timer dari sekarang sebagai fallback
                startGradingTimer(new Date().toISOString());
            }
        ...
        function startGradingTimer(startTimeStr) {
