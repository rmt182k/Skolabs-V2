...
<div class="container-fluid">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10 col-xl-8">
            ...
            <div id="sticky-timer-bar" class="alert alert-warning shadow-sm sticky-top d-none align-items-center justify-content-between mb-3" style="z-index: 1020; top: 1rem;">
                <div>
                    <strong><i class="fas fa-hourglass-half me-2"></i>Sisa Waktu:</strong>
                </div>
                <div>
                    <span id="timer-display" class="fw-bold fs-5">--:--:--</span>
                </div>
            </div>
